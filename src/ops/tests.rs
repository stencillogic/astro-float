...
fn ttt() {
    ...
    let n = BigFloatNumber::parse("-1.-1001", crate::Radix::Bin, 2112, RoundingMode::None).unwrap();
    let v = n.atan(2112, RoundingMode::None, &mut cc).unwrap();
...
fn test_sin_asin() {
    ...
    let pi = cc.pi(33 * WORD_BIT_SIZE, RoundingMode::None).unwrap();
